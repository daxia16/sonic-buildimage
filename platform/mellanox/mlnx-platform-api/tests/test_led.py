...
class TestLed:
    ...
    def _verify_uid_led(self, physical_led, obj):
        ...
        mock_file_content[physical_led.get_blue_led_path()] = Led.LED_OFF
    ...
    def _mock_led_file_content(self, led):
        return {
            ...
            led.get_blue_led_path(): Led.LED_OFF,
            ...
            led.get_blue_led_delay_off_path(): Led.LED_OFF,
            led.get_blue_led_delay_on_path(): Led.LED_OFF,
        }
